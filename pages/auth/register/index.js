...
const RegisterPage = () => {
    ...
    const dropdownItems = [
        ...
        { name: 'Secretaria', value: 'recepcionista' },         //Medico
        { name: 'Profesor', value: 'medico' },        //Reecepcionista
    ...
    return (
        <div className={containerClassName}>
            ...
            <div className="flex flex-column align-items-center justify-content-center">
                <img src={`COLEGIO.PNG`} alt="COLEGIO.PNG" className="mb-5 w-6rem flex-shrink-0" />
                <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, var(--primary-color) 10%, rgba(255, 165, 0, 0) 40%)' }}>
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <Button label="Registrar" className="block w-full p-3 text-xl bg-blue-400" type='submit'></Button>
