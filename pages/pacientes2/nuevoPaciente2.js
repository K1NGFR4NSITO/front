...
import { registrar, listarDirecciones } from '../../services/apiPacientes2';
...
export const NuevoPaciente = () => {
    ...
    let today = new Date();
    let minDate = new Date(today.getFullYear() - 13, today.getMonth(), today.getDate()); // Hace 13 años
    let maxDate = new Date(today.getFullYear() - 11, today.getMonth(), today.getDate()); // Hace 11 años
    ...
    return (
        <div className="grid">
            ...
            <div className="col-12 md:col-12">
                        ...
                        <div className="col-12 md:col-4">
                            <div className="field">
                                ...
                                <Calendar
                                    ...
                                    showIcon
                                    dateFormat="yy/mm/dd"
                                    minDate={minDate} // Hace 13 años
                                    maxDate={maxDate} // Hace 11 años
                                    required
                                    autoFocus
                                    placeholder="Escoja la fecha de nacimiento del estudiante"
                                />
                            </div>
                        </div>
                ...
                <div className='card p-fluid'>
                    <div className="field">
                        <h5 htmlFor="direccion">Datos de la direccion actual del estudiante</h5>
                    </div>
                    <div className="grid">
                        <div className="col-12 md:col-6">
                            <div className="field">
