...
const Pacientes = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Gestion de estudiantes</h5>
    ...
    function exportToPDF() {
        ...
        const introText = 'A continuación se presenta un informe detallado de los estudiantes registrados en nuestra aplicación. El informe incluye información relevante sobre cada paciente, como sus nombres, apellidos, fecha de nacimiento, telefono, y el correo.';
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={pacienteUpdateDialog} style={{ width: 'auto' }} header="Actualizar Estudiante" modal className="p-fluid" footer={pacienteUpdateDialogFooter} onHide={hideDialog}>
                        <div className="grid">
                            <div className="col-12 md:col-6">
                                <div className="field">
                                    <label htmlFor="nombresPaciente">Nombres del estudiantes</label>
                            ...
                            <div className="col-12 md:col-6">
                                <div className="field">
                                    <label htmlFor="apellidosPaciente">Apellidos del estudiantes</label>
                        ...
                        <div className="field">
                            <label htmlFor="fecha_nacimiento">Fecha de nacimiento del estudiantes</label>
                            <Calendar
                                id="fecha_nacimiento"
                        ...
                        <div className="field">
                            <label htmlFor="sexo">Genero del estudiantes</label>
                        ...
                        <div className="grid">
                            ...
                            <div className="col-12 md:col-6">
                                <div className="field">
                                    <label htmlFor="telefono">Telefono del estudiantes</label>
                        ...
                        <div className="field">
                            <label htmlFor="correo_electronico">Correo electronico del estudiantes</label>
                    ...
                    <Dialog visible={deletePacienteDialog} style={{ width: '450px' }} header="Confirm" modal footer={deletePacienteDialogFooter} onHide={hideDeletePacienteDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {paciente && (
                                <span>
                                    Esta seguro de eliminar el siguiente estudiante: <b>{paciente.nombres}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
                    ...
                    <Dialog visible={deletePacientesDialog} style={{ width: '450px' }} header="Confirm" modal footer={deletePacientesDialogFooter} onHide={hideDeletePacientesDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {paciente && <span>Esta seguro de eliminar los siguiente estudiantes seleccionados?</span>}
                        </div>
                    </Dialog>
