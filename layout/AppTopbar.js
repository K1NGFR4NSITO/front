...
const AppTopbar = forwardRef((props, ref) => {
    ...
    return (
        <div className="layout-topbar">
            <Link href="/" className="AAAAA-logo">
                <img src={`.png`} width="40px" height={'40px'} widt={'true'} alt="logo" />
                <span className=' font-semibold text-blue-400 text-3xl'>COLEGIO SANTA ANA</span>
            </Link>
